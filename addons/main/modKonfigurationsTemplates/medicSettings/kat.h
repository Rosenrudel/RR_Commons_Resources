...
force force kat_gui_showInactiveStatuses = false;
kat_gui_showPatientSideLabels = true;

// KAT - ADV Medical: Misc
force kat_misc_allowSharedVehicleEquipment = 4;     // Vehicle first
...
force force kat_surgery_closedLocation = 3;     // Medical Location & Vehicle
...
force kat_surgery_Surgery_ConsciousnessRequirement = 3;     // Anesthesia requiered
force force kat_surgery_surgicalAction_MedLevel = 2;
force force kat_surgery_surgicalLocation = 3;       // Medical Location & Vehicle
